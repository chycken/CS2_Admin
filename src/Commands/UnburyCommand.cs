...
public class UnburyCommand : CommandBase
{
    ...
    {
        RunTargetedFunCommand(context, CommandsConfig.Unbury, Permissions.Unbury, "unbury_usage", _adminDbManager, "Unbury",
            ...
            onMainThread: (ctx, args, targets, adminName) =>
            {
                ...
                _ = AdminLogManager.AddLogAsync("unbury", adminName, ctx.Sender?.SteamID ?? 0, null, null, $"targets={targets.Count}");
